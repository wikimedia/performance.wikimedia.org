...
The static site is generated by [Jigsaw](https://jigsaw.tighten.com/docs/local-development/) with [Blade templates](https://laravel.com/docs/12.x/blade).

## Prerequisites

* PHP 8.2 or later, with [Composer](https://getcomposer.org/).
